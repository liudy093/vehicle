    ...
    def pub_callback_pid(self):
        ...
        if self.refSpeed < 0.05:
            if self.nowSpeed < 0.1:
                ...
                msgPid.throttle_percentage = 0
                msgPid.braking_percentage = int(15 * self.braking_distance)
            ...
            if(errorSpeed >0.5):    #减速
                ...
                if self.nowPitch > 2:
                    print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
                    refThrottle = -100*(errorSpeed * 0.5 + self.speedControlEii * 0.01)
                else:
                    refThrottle = -100*(errorSpeed * 0.2 + self.speedControlEii * 0.005)
...
######################
        ...
        if self.trajectory_state == False:
            msgPid.throttle_percentage = 0
            msgPid.braking_percentage = 30
            msgPid.angle = 0.0
